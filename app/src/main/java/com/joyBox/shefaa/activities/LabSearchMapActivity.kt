...
import com.joyBox.shefaa.di.component.DaggerLabSearchMapComponent
...
import com.joyBox.shefaa.fragments.bottomSheetFragments.DoctorSnippetBottomFragment
import com.joyBox.shefaa.fragments.bottomSheetFragments.LabSnippetBottomFragment
import com.joyBox.shefaa.networking.NetworkingHelper
import javax.inject.Inject

class LabSearchMapActivity : BaseActivity(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback,
        LabContract.View {
            ...
            override fun onLocationResult(p0: LocationResult?) {
                ...
                if (p0?.lastLocation != null) {
                    ...
                    if (firstLocation) {
                        ...
                        labPresenter.loadLabList(NetworkingHelper.Lab_Search_Url)
//                                pointEntity =
...
//        mMap.isMyLocationEnabled = true
        ...
        task.addOnFailureListener { e ->
            ...
            if (e is ResolvableApiException) {
                ...
                try {
                    ...
                    e.startResolutionForResult(this@LabSearchMapActivity,
    ...
    private fun initDI() {
        val component = DaggerLabSearchMapComponent.builder()
//                .tagsCollectionModule(TagsCollectionModule(this))
                .labModule(LabModule(this))
                .build()
        component.inject(this)

        labPresenter.attachView(this)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.lab_search_map_layout)
...
//                , DummyDataRepositories.getBusinessGuideList())
    ...
    override fun onMarkerClick(p0: Marker?): Boolean {
        if (p0 != null) {
            if (p0.tag is Lab) {
                val labSnippetBottomFragment = LabSnippetBottomFragment.getNewInstance(p0.tag as Lab)
                labSnippetBottomFragment.show(supportFragmentManager,
                        LabSnippetBottomFragment.LabSnippetBottomFragment_Tag)
            }
        }
        return false
    }
    ...
    override fun onLabListLoaded(labList: MutableList<Lab>) {
        labList.forEach {
            try {
                addMarker(it, it.getName(), PointEntity(it.address.latitude.toDouble(), it.address.longitude.toDouble()))
            } catch (ex: Exception) {
...
//    }
    ...
    private fun addMarker(lab: Lab, title: String, pointEntity: PointEntity) {
        try {
