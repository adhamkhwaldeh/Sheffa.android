...
import com.joyBox.shefaa.di.component.DaggerDoctorSearchMapComponent
...
class DoctorSearchMapActivity : BaseActivity(), GoogleMap.OnMarkerClickListener, OnMapReadyCallback,
        DoctorContract.View {
...
//        mMap.isMyLocationEnabled = true
        ...
        task.addOnFailureListener { e ->
            ...
            if (e is ResolvableApiException) {
                ...
                try {
                    ...
                    e.startResolutionForResult(this@DoctorSearchMapActivity,
    ...
    private fun initDI() {
        val component = DaggerDoctorSearchMapComponent.builder()
//                .tagsCollectionModule(TagsCollectionModule(this))
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.doctor_search_map_layout)
...
//                , DummyDataRepositories.getBusinessGuideList())
    ...
    override fun onMarkerClick(p0: Marker?): Boolean {
        if (p0 != null) {
            if (p0.tag is Doctor) {
                val doctorSnippetBottomFragment = DoctorSnippetBottomFragment.getNewInstance(p0.tag as Doctor)
                doctorSnippetBottomFragment.show(supportFragmentManager,
                        DoctorSnippetBottomFragment.DoctorSnippetBottomFragment_Tag)
            }
        }
        return false
    }
    ...
    override fun onDoctorListLoadedSuccessfully(doctorList: MutableList<Doctor>) {
        doctorList.forEach {
            try {
                addMarker(it, it.getName(), PointEntity(it.latitude.toDouble(), it.longitude.toDouble()))
            } catch (ex: Exception) {
...
//    }
    ...
    private fun addMarker(doctor: Doctor, title: String, pointEntity: PointEntity) {
        try {
