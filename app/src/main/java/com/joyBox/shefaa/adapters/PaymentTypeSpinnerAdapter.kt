...
class PaymentTypeSpinnerAdapter(val context: Context, val paymentTypeList: MutableList<PaymentType>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        val view: View
        if (convertView == null) {
            view = mInflater.inflate(R.layout.payment_type_item, parent, false)
        } else {
            view = convertView
        }

        val specializationName: TextView = view.findViewById(R.id.specializationName)
        specializationName.text = paymentTypeList[position].name
...
//        view.layoutParams = params
    ...
    override fun getCount(): Int = paymentTypeList.size
